...
export class AppComponent implements OnInit{
  ...
  public ngOnInit(): void {
    const headers = new HttpHeaders({'Authorization':'Bearer 12351~U8SRdwOSQcRQcDt9S0xZCuPeKYyAoAEbqaQduP66chRODLDNv41ZXmokghDuLJaA'});
    this.httpClient.get(this.canvasAssignmentsUrl, {headers: headers}).subscribe(assignments => this.assignments = assignments, err => console.log("there was an error reading the canvas service"));
  }
}
